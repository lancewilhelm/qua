...
<template>
    <div class="flex row-start-padding-start z-10 full-width">
        <div class="flex text-4xl m-2 font-alt font-bold text-logo">
            <div id="logo">qua</div>
        </div>
        ...
        <span v-if="projectStore.currentProject && loggedIn" class="flex self-center text-sub border-l border-sub h-12 mx-2" />
        <div
