...
<template>
    <div class="grid gap-8 narrow-width scroll">
        <div class="text-3xl font-black font-mono text-(--main-color)">profile</div>
        ...
        <div class="text-3xl font-black font-mono text-(--main-color)">code page</div>
                ...
                <div class="grid gap-2 grid-cols-3">
                    <div class="flex flex-col items-center">
                        <Icon
                            ...
                            :class="[
                                'text-3xl text-(--main-color) opacity-0 transition-opacity duration-300',
                                {
                                    'opacity-100':
        ...
        <div class="text-3xl font-black font-mono text-(--main-color)">codes</div>
        <SettingsGroupSection
        ...
        <!-- <div class="text-3xl font-black font-mono text-(--main-color)">login</div>
        <div class="settings-group">TBD</div> -->

        <div class="text-3xl font-black font-mono text-(--main-color)">theme</div>
        <SettingsGroupSection
            title="random theme"
            icon="fa6-solid:brush"
