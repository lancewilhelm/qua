...
<template>
    <div
        ...
        ref="el"
    >
        <div class="flex px-2.5 text-base font-mono bg-(--main-color) text-sub-alt rounded-tl-lg rounded-tr-lg border-b-1 border-bg">
            <div
                :class="['py-1 px-2 cursor-pointer transition-all duration-300 hover:bg-(--sub-color)', { 'bg-(--sub-color)': activeTab === 'codes' }]"
                @click="activeTab = 'codes'"
            >
                Codes
            </div>
            <div
                :class="['py-1 px-2 cursor-pointer transition-all duration-300 hover:bg-(--sub-color)', { 'bg-(--sub-color)': activeTab === 'quotes' }]"
