...
<template>
    <div class="flex flex-col overflow-y-auto bg-(--main-color) text-(--bg-color) h-full">
        <div class="flex">
            <div
                :class="[
                    'px-1 hover:bg-(--sub-color) cursor-pointer',
                    { '!bg-(--sub-color)': activeTab === 'code' },
                ]"
