...
<template>
  <footer
    class="grid grid-cols-3 col-start-[content] row-start-[content-end] p-2 items-center text-sub font-mono text-center"
  >
    ...
    <div>
      <div id="footer-logo" class="logo text-(--main-color) font-semibold">
        qua
      </div>
    </div>
    <div>
      <div
        class="flex items-center justify-center gap-2 cursor-pointer text-sm text-(--main-color)"
