...
<template>
    <div
        :class="[
            ...
            {
                'bg-(--sub-color) outline-sub text-text': notification.type === 'info',
                'bg-(--error-color) outline-error text-text':
                    notification.type === 'warning',
                'bg-(--main-color) outline-main text-(--bg-color)': notification.type === 'success',
            },
        ]"
    >
        <div class="flex flex-row p-2 gap-2 items-center">
            ...
            <div
                class="flex grow justify-end text-2xl cursor-pointer hover:text-(--bg-color) active:translate-x-2px active:translate-y-3px transition-all duration-50"
                @click="$emit('close')"
            >
        ...
        <div
            ...
            :class="[
                'h-1',
                {
                    'bg-(--bg-color)': notification.type === 'success',
