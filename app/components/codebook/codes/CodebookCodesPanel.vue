...
<template>
    ...
    >
        ...
        >
            <div class="font-mono text-(--main-color) text-left">code name</div>
            <textarea
                id="new-code-name"
                class="resize-y"
            ...
            />
            <div>
                <div class="font-mono text-(--main-color) text-left">color</div>
        ...
        >
            <div class="font-mono text-(--main-color) text-left">group name</div>
            <input
        ...
        >
            <div
                ...
                class="font-mono text-(--main-color) text-left"
            >
                code name
            </div>
            <div
        ...
        >
            <div class="font-mono text-(--main-color) text-left">delete code</div>
