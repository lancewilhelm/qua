...
<template>
    <div class="flex flex-col h-full">
        <div class="flex bg-(--main-color) font-mono justify-center">
            <span class="w-px my-2 bg-(--sub-color)-alt" />
        ...
        <div class="flex bg-(--main-color) text-sub-alt font-mono p-2.5 border-t-1 border-bg">
