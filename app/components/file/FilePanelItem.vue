...
<template>
    <div
        class="flex p-2 cursor-pointer items-center text-text transition-all duration-300"
    >
        ...
        <div v-if="file.id === currentFile.id" class="flex text-(--main-color) grow justify-end translate-x-2.5">
