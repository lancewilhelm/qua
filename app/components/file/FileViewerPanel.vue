...
<template>
    ...
    >
        ...
        >
            ...
            <div v-if="editorRightClickContext === 'code'" class="grid">
                <div
                    ...
                    class="context-menu-code group grid grid-cols-color-picker gap-2 p-1 cursor-pointer hover:font-bold hover:text-(--bg-color) transition-all duration-50"
        ...
        >
            <div class="font-mono text-(--main-color) font-bold text-base mb-2">
                quote
            </div>
            ...
            <div class="font-mono text-(--main-color) font-bold text-base mb-1">code</div>
            <textarea
            ...
            />
            <div class="font-mono text-(--main-color) font-bold text-base mb-1">memo</div>
            <textarea
                ...
                @keydown.enter.prevent="addCodeInstance"
            />
            <div class="font-mono text-(--main-color) font-bold text-base mb-1">
                importance
            </div>
            <div class="flex gap-2 mb-2">
                <button
                    v-for="i in 5"
                    :class="[{ 'bg-(--main-color) text-(--bg-color)': newCode.importance === i }]"
                    @click="
        ...
        >
            ...
            <div class="font-mono text-(--main-color) font-bold text-base mb-2">code</div>
            <textarea
            ...
            <div class="flex gap-2 mb-2">
                <button
                    v-for="i in 5"
                    :class="[{ 'bg-(--main-color) text-(--bg-color)': editCode.importance === i }]"
                    @click="
