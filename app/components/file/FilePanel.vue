...
<template>
    <div class="flex flex-col bg-(--sub-color) text-text items-stretch overflow-x-hidden rounded-tl-lg rounded-bl-lg border-main border-y-3 border-l-3" :style="{ width: width + 'px' }">
        ...
        >
            ...
            <div class="font-mono text-(--main-color) text-left">new name</div>
            <input
